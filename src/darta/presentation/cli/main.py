...
def _build_argument_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Parse Dart source code with ANTLR.")
    parser.add_argument("--verbose", action="store_true", help="Enable lifecycle logging.")
    subparsers = parser.add_subparsers(dest="command", required=True)

    parse_file = subparsers.add_parser("parse-file", help="Parse one Dart file.")
    parse_file.add_argument("path", help="Path to a .dart file.")

    parse_dir = subparsers.add_parser("parse-dir", help="Parse all Dart files in a directory.")
    parse_dir.add_argument("path", help="Path to a directory.")

    nassi_file = subparsers.add_parser(
        "nassi-file",
        help="Build a Nassi-Shneiderman HTML diagram for one Dart file.",
    )
    nassi_file.add_argument("path", help="Path to a .dart file.")
    ...
    nassi_dir = subparsers.add_parser(
        "nassi-dir",
        help="Build Nassi-Shneiderman HTML diagrams for all Dart files in a directory.",
    )
...
<html lang="en">
  ...
  <body>
    <div class="window">
      <div class="titlebar">Darta NSD Index</div>
      <div class="body">
